...
# Dataset (choose one).
# desc += '-oct64';             dataset = EasyDict(tfrecord_dir='oct64')
# desc += '-oct128';             dataset = EasyDict(tfrecord_dir='oct128')
# desc += '-oct256';             dataset = EasyDict(tfrecord_dir='oct256')
# desc += '-oct512';             dataset = EasyDict(tfrecord_dir='oct512')
desc += '-oct1024';             dataset = EasyDict(tfrecord_dir='oct1024')
