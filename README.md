...
* **Movie Generation**: Renumber the snapshots generated in training as 0000.png, 0001.png, ..., and use following command to generate movie: `ffmpeg -r 5 -i %04d.png -vcodec mpeg4 -y movie.mp4`.